...
const ProfileCard = ({ name, handle, img }) => {
        ...
        <section className="mx-2 basis-[73%]">
          ...
          <h2 className="text-[0.6rem] text-[#F2F4F7]">
            ...
            primaryProfile?.handle
              ? primaryProfile?.handle.length > 18
                ? primaryProfile?.handle.substring(0, 11) +
                  ".." +
                  primaryProfile?.handle.substring(
                    primaryProfile?.handle.length - 6,
                    primaryProfile?.handle.length
                  )
                : primaryProfile?.handle
              : ""} */}
          </h2>
