...
const PostInput = () => {
  ...
  return (
    <div className="bg-[#13141D] border-[#414141] border rounded-lg flex py-4  mx-auto my-2 mb-9">
      <section className="basis-[10%]">
        <Image
      ...
      <section className="basis-[88%] pr-3 pl-1">
        <div className="flex bg-[#070B13] rounded-lg">
          <input
            ...
            className="basis-[90%] outline-none p-3 text-lg rounded-lg bg-[#070B13] text-white"
          />
        </div>
        <div className="flex justify-between my-4">
          ...
          <button
            className="rounded-lg p-2 hover:scale-105 ease-in-out duration-300 w-[17%] bg-gradient-to-r from-[#B537E5] via-[#F44A9B]  to-[#FF876E]"
